...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                'include' => [
                    storage_path('app/public'), // Chỉ thư mục chứa ảnh hoặc file upload
                ],
                'exclude' => [
                    base_path('vendor'), // Loại trừ thư mục không cần thiết
            ...
            'databases' => [
                'mysql', // Đảm bảo tên kết nối database của bạn ở đây
            ],
        ],
