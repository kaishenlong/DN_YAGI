...
//                             {
//                               Categorys.map((category:IPCategory,index:number)=>(
...
//                                     <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline"><Link to={`/dashboard/category/edit/${category.id}`}>Edit</Link></a>

//                                     <button onClick={() => onDelete(category.id)} className="text-red-600 ml-4 dark:text-red-500 hover:underline">
//                                     Delete
//                                     </button>
//                                 </td>
//                                 </tr>
