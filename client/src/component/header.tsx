          ...
          <div className='flex items-center justify-between p-4 bg-[#00396B96]'>
            ...
            >
              <div className='flex flex-col md:flex-row font-judson text-white text-[25px] md:text-[24px] text-center space-y-4 md:space-y-0 md:space-x-20 p-4 md:p-0'>
                ...
                <Link to='/About' className='hover:text-yellow-400 hover:underline'>
                  Về chúng tôi
                </Link>
                <Link to='/Services' className='hover:text-yellow-400 hover:underline'>
                  Dịch vụ
                </Link>
                <Link to='/News' className='hover:text-yellow-400 hover:underline'>
                  Tin tức
                </Link>
                <Link to='/Contact' className='hover:text-yellow-400 hover:underline'>
                  Liên hệ
                </Link>
              </div>
            </nav>
            ...
            {isLoggedIn ? (
              <div className='relative text-white'>
                <button onClick={togglePopup} className='flex items-center space-x-2'>
                  <FaUserCircle className='w-8 h-8' />
                  <span className='md:inline'>{userName}</span>
                </button>
                <AccountPopup isOpen={isPopupOpen} onClose={togglePopup} onLogout={onLogout} userName={userName}/>
              </div>
            ) : (
